...
//    System.out.println("BlockPlacementPolicyDefault-chooseTarget(short)-chosenNodes.size()"+chosenNodes.size());
//    System.out.println("BlockPlacementPolicyDefault-chooseTarget(short)-excludedNodes.size()"+excludedNodes.size());
...
//    System.out.println("BlockPlacementPolicyDefault-chooseTarget(implementation)-start-chosenNodes.size()"+chosenStorage.size());
//    System.out.println("BlockPlacementPolicyDefault-chooseTarget(implementation)-start-excludedNodes.size()"+excludedNodes.size());
...
//    System.out.println("BlockPlacementPolicyDefault-chooseTarget(implementation)-end-excludedNodes.size()"+excludedNodes.size());
